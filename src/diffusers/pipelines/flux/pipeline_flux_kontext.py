...
class FluxKontextPipeline(
    ...
    def set_terra_t(self, terra_t: Union[float, torch.Tensor, List[float]], adapter: Optional[str] = None, batch_size=1, num_images_per_prompt=1, do_true_cfg=False):
        """
        ...
        if terra_t is not None:
            ...
            if hasattr(self.transformer, "set_terra_t"):
                ...
                expected_batch_size = batch_size * cfg_batch_multiplier * num_images_per_prompt
