...
DIFFUSERS_TO_PEFT = {
    ...
    ".q_proj.lora_linear_layer.mid": ".q_proj.lora_M",
    ".k_proj.lora_linear_layer.up": ".k_proj.lora_B",
    ".k_proj.lora_linear_layer.down": ".k_proj.lora_A",
    ".k_proj.lora_linear_layer.mid": ".k_proj.lora_M",
    ".v_proj.lora_linear_layer.up": ".v_proj.lora_B",
    ".v_proj.lora_linear_layer.down": ".v_proj.lora_A",
    ".v_proj.lora_linear_layer.mid": ".v_proj.lora_M",
    ".out_proj.lora_linear_layer.up": ".out_proj.lora_B",
    ".out_proj.lora_linear_layer.down": ".out_proj.lora_A",
    ".out_proj.lora_linear_layer.mid": ".out_proj.lora_M",
    ".q.lora_linear_layer.up": ".q.lora_B",
    ".q.lora_linear_layer.down": ".q.lora_A",
    ".q.lora_linear_layer.mid": ".q.lora_M",
    ".k.lora_linear_layer.up": ".k.lora_B",
    ".k.lora_linear_layer.down": ".k.lora_A",
    ".k.lora_linear_layer.mid": ".k.lora_M",
    ".v.lora_linear_layer.up": ".v.lora_B",
    ".v.lora_linear_layer.down": ".v.lora_A",
    ".v.lora_linear_layer.mid": ".v.lora_M",
    ".o.lora_linear_layer.up": ".o.lora_B",
    ".o.lora_linear_layer.down": ".o.lora_A",
    ".o.lora_linear_layer.mid": ".o.lora_M",
    ".lora_linear_layer.up": ".lora_B",
    ".lora_linear_layer.down": ".lora_A",
    ".lora_linear_layer.mid": ".lora_M",
...
PEFT_TO_DIFFUSERS = {
    ...
    ".q_proj.lora_M": ".q_proj.lora_linear_layer.mid",
    ".k_proj.lora_B": ".k_proj.lora_linear_layer.up",
    ".k_proj.lora_A": ".k_proj.lora_linear_layer.down",
    ".k_proj.lora_M": ".k_proj.lora_linear_layer.mid",
    ".v_proj.lora_B": ".v_proj.lora_linear_layer.up",
    ".v_proj.lora_A": ".v_proj.lora_linear_layer.down",
    ".v_proj.lora_M": ".v_proj.lora_linear_layer.mid",
    ".out_proj.lora_B": ".out_proj.lora_linear_layer.up",
    ".out_proj.lora_A": ".out_proj.lora_linear_layer.down",
    ".out_proj.lora_M": ".out_proj.lora_linear_layer.mid",
    ".q.lora_B": ".q.lora_linear_layer.up",
    ".q.lora_A": ".q.lora_linear_layer.down",
    ".q.lora_M": ".q.lora_linear_layer.mid",
    ".k.lora_B": ".k.lora_linear_layer.up",
    ".k.lora_A": ".k.lora_linear_layer.down",
    ".k.lora_M": ".k.lora_linear_layer.mid",
    ".v.lora_B": ".v.lora_linear_layer.up",
    ".v.lora_A": ".v.lora_linear_layer.down",
    ".v.lora_M": ".v.lora_linear_layer.mid",
    ".o.lora_B": ".o.lora_linear_layer.up",
    ".o.lora_A": ".o.lora_linear_layer.down",
    ".o.lora_M": ".o.lora_linear_layer.mid",
    "to_k.lora_A": "to_k.lora.down",
    "to_k.lora_B": "to_k.lora.up",
    "to_k.lora_M": "to_k.lora.mid",
    "to_q.lora_A": "to_q.lora.down",
    "to_q.lora_B": "to_q.lora.up",
    "to_q.lora_M": "to_q.lora.mid",
    "to_v.lora_A": "to_v.lora.down",
    "to_v.lora_B": "to_v.lora.up",
    "to_v.lora_M": "to_v.lora.mid",
    "to_out.0.lora_A": "to_out.0.lora.down",
    "to_out.0.lora_B": "to_out.0.lora.up",
    "to_out.0.lora_M": "to_out.0.lora.mid",
}

DIFFUSERS_OLD_TO_DIFFUSERS = {
    ".to_q_lora.up": ".q_proj.lora_linear_layer.up",
    ".to_q_lora.down": ".q_proj.lora_linear_layer.down",
    ".to_q_lora.mid": ".q_proj.lora_linear_layer.mid",
    ".to_k_lora.up": ".k_proj.lora_linear_layer.up",
    ".to_k_lora.down": ".k_proj.lora_linear_layer.down",
    ".to_k_lora.mid": ".k_proj.lora_linear_layer.mid",
    ".to_v_lora.up": ".v_proj.lora_linear_layer.up",
    ".to_v_lora.down": ".v_proj.lora_linear_layer.down",
    ".to_v_lora.mid": ".v_proj.lora_linear_layer.mid",
    ".to_out_lora.up": ".out_proj.lora_linear_layer.up",
    ".to_out_lora.down": ".out_proj.lora_linear_layer.down",
    ".to_out_lora.mid": ".out_proj.lora_linear_layer.mid",
