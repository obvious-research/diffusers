...
class FluxPanoramaPipeline(metaclass=DummyObject):
    _backends = ["torch", "transformers"]
...
class FluxRegionalPipeline(metaclass=DummyObject):
    _backends = ["torch", "transformers"]
...
class FluxPanoramaRegionalPipeline(metaclass=DummyObject):
    _backends = ["torch", "transformers"]
